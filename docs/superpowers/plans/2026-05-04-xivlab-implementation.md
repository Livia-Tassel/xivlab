...
- [ ] **Step 11: Append sqlite-vec virtual table to the migration**
...
- [ ] **Step 12: Add seed migration for prompt_categories**
...
- [ ] **Step 14: tests/unit/test_models.py**
